...
public class RandomSpawner : MonoBehaviour
{
    ...
    //private void Update()
    //{
    //    Debug.DrawRay(transform.position + new Vector3(0, 1, 0), Vector3.down * 10, Color.red);

    //    RaycastHit hit;

    //    if (Physics.Raycast(transform.position + new Vector3(0, 1, 0), Vector3.down, out hit, 10, 1 << 6))
    //    {
    ...
    public void Spawn()
    {
        ...
        //if (Physics.Raycast(spawnPosition + new Vector3(0, 1, 0), Vector3.down, out hit, 10, 1<<6))
        //{
        //    spawnPosition = hit.point;
        //}

        //hitPosition = spawnPosition;
